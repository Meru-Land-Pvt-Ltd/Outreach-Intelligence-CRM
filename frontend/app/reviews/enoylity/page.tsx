...
export default async function EnoylityReviewsPage() {
  const response = await apiGet("/reviews/enoylity");
  ...
  return (
    <main className="w-full space-y-6">
      ...
      <DataSection title="Enoylity Reviews" description={`${rows.length} videos`}>
        <Table>
          <TableHeader>
            <TableRow>
