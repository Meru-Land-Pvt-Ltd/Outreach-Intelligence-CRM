...
export function buildRawVideoAnalysisPrompt(batch: RawVideoPromptItem[]) {
  let prompt =
    ...
    "Use 1-3 words max.\n" +
    "2. Sponsor Brand — What is the PRIMARY brand being featured, promoted, or reviewed in this video?\n" +
    ...
    "If the video is published by the brand's OWN channel (self-promotion, ads, official product videos), write 'None'. " +
    "Large platform/retailer names that are not being promoted (e.g. Amazon, YouTube, Google as a platform) are NOT sponsor brands.\n" +
    ...
    "5. Sponsorship Type — Based on duration and content. Genuine sponsorship/collaboration signals " +
    "(sponsored disclosure, promo/discount code, affiliate links, dedicated review, unboxing of a sent unit) " +
    "must be distinguished from a creator merely USING a product in a tutorial:\n" +
    " - Dedicated Review (5+ min video fully about one product)\n" +
    " - Comparison (multiple products compared)\n" +
    " - Integration (brand promoted within a longer video about something else)\n" +
    ...
    " - Tutorial Mention (how-to/tutorial video that merely uses the product, with NO sponsorship or promotion intent)\n" +
